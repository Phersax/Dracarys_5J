...
int main(void) {
	...
	stepper_move(&stp4, CLOCKWISE, 35, 40);

	HAL_Delay(1600);

	stepper_move(&stp4, CLOCKWISE, 7, 16);

	stepper_move(&stp2, CLOCKWISE, 30, 40);
	stepper_move(&stp3, COUNTERCLOCKWISE, 30, 40);
	...
	stepper_move(&stp4, COUNTERCLOCKWISE, 7, 16);
	servo_move(&srv2, -90);

	HAL_Delay(20);

	stepper_move(&stp2, COUNTERCLOCKWISE, 30, 40);
	stepper_move(&stp3, CLOCKWISE, 30, 40);

	stepper_move(&stp4, COUNTERCLOCKWISE, 35, 40);
